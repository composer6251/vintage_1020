...
class InventoryParallax extends StatelessWidget {
  const InventoryParallax({super.key});
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        children: [
          for (final location in pictures)
            InventoryListItem(
...
const pictures = [
  Picture(
    name: 'Mount Rushmore',
    place: 'U.S.A',
    imageUrl: 'resources/images/A7A830DA-D46D-46AE-AE61-D15CAE6C4058_1_105_c.jpeg',
  ),
  Picture(
    name: 'Gardens By The Bay',
    place: 'Singapore',
    imageUrl: 'resources/images/A87B9591-6254-4B74-88D3-02A168915297_1_105_c.jpeg',
  ),
];